...
``magpie-schwab-nt``'s parsers, streamer client, and auth layer.
...
Entry point: ``python -m magpie_md_bridge.schwab`` (see ``__main__.py``).
systemd unit: ``research/magpie-md-bridge/systemd/schwab-md-bridge.service``.
"""

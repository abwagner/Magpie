"""Smoke tests for the magpie-md-bridge package skeleton (M13-02).
...
def test_package_importable() -> None:
    ...
    import magpie_md_bridge

    assert magpie_md_bridge.__doc__ is not None


def test_subpackages_importable() -> None:
    """Schwab + IBKR subpackages are importable stubs."""
    from magpie_md_bridge import ibkr, schwab

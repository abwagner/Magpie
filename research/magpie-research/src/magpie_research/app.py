...
guards — see :func:`magpie_research.guards.assert_no_duckdb_writes`.
"""
...
from magpie_research.guards import assert_no_duckdb_writes
from magpie_research.jobs import JobStore
from magpie_research.nats import NatsAdapter, RealNatsAdapter
from magpie_research.routes import get_events, get_pool, get_store, router
from magpie_research.workers import StubWorkerPool, WorkerPool
...
API_DESCRIPTION = (
    ...
    "in src/magpie_research/config.py; this OpenAPI document is "

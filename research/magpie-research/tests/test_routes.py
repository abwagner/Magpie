"""Tests for ``magpie_research.routes`` — FastAPI endpoints
...
import httpx
import pytest
from magpie_research.app import create_app
...
from magpie_research.workers import SynchronousStubPool
...
class TestEventPublishingThroughRoutes:
    ...
    async def test_end_to_end_publishes_data_write_results(self) -> None:
        ...
        assert payload["producer"] == "magpie-research"

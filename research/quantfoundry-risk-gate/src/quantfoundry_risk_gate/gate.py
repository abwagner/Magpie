...
from quantfoundry_risk_gate.wire import GateRequest, GateResponse
...
class QFRiskGate:
    ...
    def _handle_revoke_request(self, raw: bytes) -> bytes:
        ...
        from quantfoundry_risk_gate.wire import RevokeRequest, RevokeResponse
    ...
    def _apply_fail_open(
        ...
        from quantfoundry_risk_gate.classifier import is_strictly_closing

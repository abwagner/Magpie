"""Schema and propagation tests for ``quantfoundry_logging``.
...
def _capture_one_line() -> dict[str, object]:
    ...
    import quantfoundry_logging  # local import to flip the configured flag

    quantfoundry_logging._configured = False
    buf = io.StringIO()
